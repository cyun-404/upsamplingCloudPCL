...
void display_upsampling(pcl::PointCloud<pcl::PointXYZRGB>::Ptr &input_cloud,
  ...
  if (input_cloud->points[0].r <= 0 && input_cloud->points[0].g <= 0 && input_cloud->points[0].b <= 0) {
  ...
  if (output_cloud->points[0].r <= 0 && output_cloud->points[0].g <= 0 && output_cloud->points[0].b <= 0) {
